...
if __name__ == "__main__":
    ...
    dev_data = read_jsonl(Path(os.path.dirname(__file__) + '\\spacy_ner\\cluener_public\\dev.json'))
    train_data = read_jsonl(Path(os.path.dirname(__file__) + '\\spacy_ner\\cluener_public\\train.json'))

    format_data_to_jsonl(dev_data, Path(os.path.dirname(__file__) + '\\spacy_ner\\spacy\\dev.jsonl'))
    format_data_to_jsonl(train_data, Path(os.path.dirname(__file__) + '\\spacy_ner\\spacy\\train.jsonl'), print_label=True)
